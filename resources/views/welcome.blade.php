...
<div id="indicators-carousel" class="relative" data-carousel="static">
    <!-- Carousel wrapper -->
    <div class="relative h-56 overflow-hidden rounded-lg md:h-96 sliderLp">
         <!-- Item 1 -->
        <div class="absolute inset-0 z-20 transition-all duration-700 ease-in-out transform translate-x-0" data-carousel-item="active">
            <img src="{{ asset('/storage/bongkar/LP BONGKARR banner 1.png') }}" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
        </div>
        <!-- Item 2 -->
        <div class="absolute inset-0 z-10 transition-all duration-700 ease-in-out transform translate-x-full" data-carousel-item="">
            <img src="{{ asset('/storage/bongkar/LP BONGKARR banner 2.png') }}" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
        </div>
        <!-- Item 3 -->
        <div class="absolute inset-0 hidden transition-all duration-700 ease-in-out transform" data-carousel-item="">
            <img src="{{ asset('/storage/bongkar/LP BONGKARR banner 3.png') }}" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
        </div>
    </div>
    <!-- Slider indicators -->
    <div class="absolute z-30 flex space-x-3 -translate-x-1/2 bottom-5 left-1/2">
        <button type="button" class="w-24 h-4 rounded-full bg-white/50 dark:bg-gray-800/50 hover:bg-green-500 dark:hover:bg-gray-800" aria-current="true" aria-label="Slide 1" data-carousel-slide-to="0"></button>
        <button type="button" class="w-24 h-4 rounded-full bg-white/50 dark:bg-gray-800/50 hover:bg-green-500 dark:hover:bg-gray-800" aria-current="false" aria-label="Slide 2" data-carousel-slide-to="1"></button>
        <button type="button" class="w-24 h-4 rounded-full bg-white/50 dark:bg-gray-800/50 hover:bg-green-500 dark:hover:bg-gray-800" aria-current="false" aria-label="Slide 3" data-carousel-slide-to="2"></button>
    </div>
    <!-- Slider controls -->
...
<div class="h-24 mx-auto bg-amber-400">
    <p class="grid pt-4 text-xl text-white place-content-center">
...
<div class="bg-yellow-50 ">
    <img src="{{ asset('/storage/bongkar/LP BONGKARR 001.png') }}" alt="logo" srcset="">

    {{-- /* body cokelat */ --}}

    <div class="body-cokelat">
        <div class="grid pb-10 place-content-center">
            <h1 class="grid font-bold text-white place-content-center lg:text-5xl ">MASALAH INIKAH</h1>
            <h1 class="font-bold text-white lg:text-5xl">YANG ANDA ALAMI ?</h1>
        </div>

        <div class="lg:mx-auto lg:max-w-4xl lg:pb-10 lg:pt-9 sm:bg-black">
            <ul class="list-disc">
                <li class="text-white sm:font-bold lg:font-bold lg:py-3 sm:text-sm lg:text-5xl">DISFUNGSI EREKSI ?</li>
                <li class="text-white lg:font-bold lg:py-3 sm:text-sm lg:text-5xl">DINI ?</li>
                <li class="text-white lg:font-bold lg:py-3 sm:text-sm lg:text-5xl">SULIT ORGASME ?</li>
                <li class="text-white lg:font-bold lg:py-3 sm:text-sm lg:text-5xl">IMPOTENSI ?</li>
                <li class="text-white lg:font-bold lg:py-3 sm:text-sm lg:text-5xl">LEMAH SYAHWAT ?</li>
                <li class="text-white lg:font-bold lg:py-3 sm:text-sm lg:text-5xl ">KURANG BERGAIRAH?</li>
            </ul>
        </div>

    {{--  /* body cokelat body-deskripsi */ --}}

        <div class="max-w-4xl px-2 mx-auto body-deskripsi">
            <p class="font-normal tracking-wide text-white lg:py-2 lg:leading-normal lg:text-4xl">
            ...
            <p class="font-normal tracking-wide text-white lg:leading-normal lg:text-4xl ">
    ...
    <div class="max-w-4xl px-4 py-10 mx-auto body-yellow-50">
        <h1 class="grid font-bold text-black place-content-center lg:text-5xl">
            BONGKARR KEBIASAAN LAMA
        </h1>
        <h3 class="grid text-black lg:pb-12 place-content-center lg:text-4xl">
            Kopi Bonkarr hadir mengatasi permasalahan Anda
        </h3>
        <h3 class="grid font-bold text-black lg:pb-5 place-content-center lg:text-3xl">
            Kopi Bongkarr merupakan kopi kesehatan dengan manfaat sebagai berikut :
        </h3>

        <div>
            <ul class="list-disc">
                <li class="text-black lg:text-3xl">Meningkatkan stamina tubuh</li>

                <li class="text-black lg:text-3xl">Menjaga kondisi tubuh tetap fit</li>

                <li class="text-black lg:text-3xl">Mengurangi resiko gangguan prostat</li>

                <li class="text-black lg:text-3xl">Meningkatkan kemampuan konsentrasi dan daya ingat</li>

                <li class="text-black lg:text-3xl">Baik untuk yang mengalami gangguan mata, karena ada
                    kandungan lutein (vitamin caratonoid)</li>

                <li class="text-black lg:text-3xl">Membantu meningkatkan vitalitas</li>
            </ul>
        </div>
    </div>
</div>
...
{{-- divider komposisi --}}
<div class="h-10 bg-amber-500 divider-komposisi">
    <div class="grid place-content-center">
        <span class="text-center rounded-full bg-amber-500 lg:h-20 lg:w-96">
            <p class="font-bold text-white lg:pt-6 lg:text-3xl">Komposisi</p>
        </span>
    </div>
</div>

{{-- bahan bahan kopi bongkar --}}
<div class="bg-amber-900 " style="background-color: #5f3829;">
    <div class="flex lg:mx-auto lg:px-4 lg:max-w-6xl lg:pt-20 lg:py-9 image-product place-content-end">
        <img src="{{ asset('/storage/bongkar/LP BONGKARR 002.png') }}" width="300" height="300" alt="logo" srcset="">
        <span class="px-5">
            <h5 class="font-bold text-yellow-300 lg:text-5xl">
                BIJI KOPI TERBAIK
            </h5>
            <p class="text-white lg:text-4xl">
    ...
    <div class="flex lg:mx-auto lg:px-4 lg:max-w-6xl lg:pt-20 lg:py-9 image-product place-content-end">
        <img src="{{ asset('/storage/bongkar/LP BONGKARR 003.png') }}" width="300" height="300" alt="logo" srcset="">
        <span class="px-5">
            <h5 class="font-bold text-yellow-300 lg:text-5xl">
            EKSTRAK GINSENG
            </h5>
    ...
    <div class="flex lg:mx-auto lg:px-4 lg:max-w-6xl lg:pt-20 lg:py-9 image-product place-content-end">
        <img src="{{ asset('/storage/bongkar/LP BONGKARR 004.png') }}" width="300" height="300" alt="logo" srcset="">
        <span class="px-5">
            <h5 class="font-bold text-yellow-300 lg:text-5xl">
                CORDYCEPS
            </h5>
    ...
    <div class="flex lg:mx-auto lg:px-4 lg:max-w-6xl lg:pt-20 lg:py-9 image-product place-content-end">
        <img src="{{ asset('/storage/bongkar/LP BONGKARR 005.png') }}" width="300" height="300" alt="logo" srcset="">
        <span class="px-5">
            <h5 class="font-bold text-yellow-300 lg:text-5xl">
                EKSTRAK GUARANA
            </h5>
    ...
    <div class="flex lg:mx-auto lg:px-4 lg:max-w-6xl lg:pt-20 lg:py-9 image-product place-content-end">
        <img src="{{ asset('/storage/bongkar/LP BONGKARR 006.png') }}" width="300" height="300" alt="logo" srcset="">
        <span class="px-5">
            <h5 class="font-bold text-yellow-300 lg:text-5xl">
                LUTEIN
            </h5>
...
{{-- divider komposisi PESAN SEKARANG --}}
<div class="grid h-28 place-content-center bg-amber-500">
    <div class="grid place-content-center">
        <span class="text-center border-green-600 border-solid rounded-full lg:border-8 bg-gradient-to-r from-green-500 to-green-400 lg:h-20 lg:w-96">
            <p class="font-bold text-white lg:pt-3 lg:text-3xl">PESAN SEKARANG</p>
        </span>
    </div>
</div>
...
<div class="grid text-center place-content-center">
    ...
    {{-- harga --}}
    {{-- <div> --}}
        <p class="z-10 text-white lg:text-5xl lg:font-bold lg:pt-24">
            IDR 350.000
        </p>
    {{-- </div> --}}
</div>
<div>
    <img class="-mt-96" src="{{ asset('/storage/bongkar/LP BONGKARR 008.png') }}" alt="logo" srcset="">
</div>


<div id="controls-carousel" class="relative text-center lg:px-11 lg:pb-20" data-carousel="static">

    <H1 class="font-bold text-white lg:py-11 lg:text-4xl">APA KATA MEREKA</H1>

    <!-- Carousel wrapper -->
    <div class="relative h-56 overflow-hidden rounded-lg md:h-96 lg:grid lg:place-content-center">
         <!-- Item 1 -->
        <div class="absolute inset-0 z-10 transition-all duration-700 ease-in-out transform -translate-x-full" data-carousel-item="">
...
<div class="bg-amber-50">
    ...
    <div class="flex justify-start">
         <img class="lg:px-9 lg:py-9" src="{{ asset('/storage/bongkar/LP BONGKARR 009.png') }}" width="300" height="300" alt="logo" srcset="">
         <div class="text-black lg:px-9 lg:py-9">
            <p class="font-bold">M.KHIDIR</p>
            <p>Guru Honorer</p>
            <p>
    ...
    {{-- Testimoni 2 --}}
    <div class="flex justify-start">
        <img class="lg:px-9 lg:py-9" src="{{ asset('/storage/bongkar/LP BONGKARR 010.png') }}" width="300" height="300" alt="logo" srcset="">
        <div class="text-black lg:px-9 lg:py-9">
           <p class="font-bold">iBU LULUK ROHANA</p>
   ...
   {{-- Testimoni 3 --}}
   <div class="flex justify-start">
    <img class="lg:px-9 lg:py-9" src="{{ asset('/storage/bongkar/LP BONGKARR 011.png') }}" width="300" height="300" alt="logo" srcset="">
        <div class="text-black lg:px-9 lg:py-9">
       <p class="font-bold">EDDIE SUROKO</p>
       <p> Pengusaha - Semarang</p>
       <p>
