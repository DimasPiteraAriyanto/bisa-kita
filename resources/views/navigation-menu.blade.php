        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="flex items-center shrink-0">
                    ...
                    <img src="{{ asset('/storage/products/000 logo.png') }}" width="50" height="50" alt="logo" srcset="">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <div class="mt-5 dropdown dropdown-hover">
                        <x-jet-nav-link href="{{ route('products.index') }}" :active="request()->routeIs('products.index')">
                            {{ __('Produk') }}
                        </x-jet-nav-link>
                        <ul tabindex="0" class="p-2 text-black bg-gray-300 dropdown-content menu rounded-box w-52">
                          <li><x-jet-nav-link href="{{ route('product.master') }}" :active="request()->routeIs('product.master')">
                            {{ __('Product Masters') }}
                            </x-jet-nav-link></li>
                          <li><x-jet-nav-link href="{{ route('products.index') }}" :active="request()->routeIs('products.index')">
                            {{ __('Produk') }}
                        </x-jet-nav-link></li>
                        </ul>
                      </div>
                      <x-jet-nav-link href="{{ route('generate-index') }}" :active="request()->routeIs('generate-index')">
                        {{ __('Generate') }}
                    </x-jet-nav-link>
                </div>
            </div>
